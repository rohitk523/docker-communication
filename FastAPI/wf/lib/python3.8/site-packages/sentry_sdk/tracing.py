...
if MYPY:
    ...
    from sentry_sdk._types import MeasurementUnit, SamplingContext
...
class Span(object):
    ...
    def iter_headers(self):
        ...
        tracestate = (
            self.to_tracestate() if has_tracestate_enabled(self) else None
        )
    ...
    def from_traceparent(
        ...
        **kwargs  # type: Any
        ...
        return cls.continue_from_headers(
            {"sentry-trace": traceparent}, **kwargs
        )
    ...
    def finish(self, hub=None):
        ...
        try:
            duration_seconds = (
                time.perf_counter() - self._start_timestamp_monotonic
            )
