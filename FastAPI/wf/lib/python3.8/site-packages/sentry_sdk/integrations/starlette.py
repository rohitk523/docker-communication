...
try:
    # Starlette 0.20
    from starlette.middleware.exceptions import (  # type: ignore
        ExceptionMiddleware,
    )
except ImportError:
    # Startlette 0.19.1
    ...
    def _sentry_middleware_init(self, *args, **kwargs):
        ...
        async def _sentry_patched_exception_handler(self, *args, **kwargs):
            ...
            is_http_server_error = (
                hasattr(exp, "staus_code") and exp.status_code >= 500
            )
