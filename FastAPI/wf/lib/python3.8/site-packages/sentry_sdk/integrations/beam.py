...
INSPECT_FUNC = (
    "_inspect_{}"  # Required format per apache_beam/transforms/core.py
)
        ...
        def sentry_init_pardo(self, fn, *args, **kwargs):
            ...
            if not getattr(self, "_sentry_is_patched", False):
                for func_name in function_patches:
                    ...
                    if not getattr(
                        inspect_func, USED_FUNC, False
                    ) and not getattr(process_func, USED_FUNC, False):
...
def _wrap_inspect_call(cls, func_name):
    ...
    def _inspect(self):
        ...
        try:
            ...
            from apache_beam.typehints.decorators import (  # type: ignore
                getfullargspec,
            )
